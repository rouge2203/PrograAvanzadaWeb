...
namespace API.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        {
            //var res = new BE.Categories(dbcontext).GetAll().ToList();
            var res = new BE.Categories(dbcontext).GetAll();
        ...
        {
            var categories = new BE.Categories(dbcontext).GetOneById(id);
        ...
        public async Task<IActionResult> PutCategories(int id, models.Categories categories)
        {
            ...
            try
            {
                ...
                new BE.Categories(dbcontext).Update(mapaux);
            }
            catch (Exception ee)
            {
        ...
        public async Task<ActionResult<models.Categories>> PostCategories(models.Categories categories)
        {
            ...
            {
                var mapaux = mapper.Map<models.Categories, data.Categories>(categories);
                new BE.Categories(dbcontext).Insert(mapaux);
            }
            catch (Exception)
            {
                BadRequest();
        ...
        public async Task<ActionResult<models.Categories>> DeleteCategories(int id)
        {
            ...
            try
            {
                new BE.Categories(dbcontext).Delete(categories);
            }
            catch (Exception)
            {
                BadRequest();
        ...
        {
            return (new BE.Categories(dbcontext).GetOneById(id) != null);
        }
    }
}
